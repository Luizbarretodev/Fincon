...
public class CriarSaidaUseCase
{
    ...
    public CriarSaidaUseCase(ISaidaRepository saidaRepository, IContaRepository contaRepository, ICategoriaSaidaRepository categoriaSaidaRepository)
    {
